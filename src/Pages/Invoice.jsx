...
const Invoice = () => {
    ...
    return (
        <div className="corporate-invoice-container">
            ...
            <div className="invoice-document paper">
                ...
                <div className="doc-section words-section border-top">
                    <p><span>Amount Chargeable (in words):</span> <br/> <strong>INR {numberToWords(order.amounts?.total)}</strong></p>
                </div>
                    ...
                    <table className="corporate-table tax-summary-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td className="text-right">{(order.amounts?.tax / 2)?.toFixed(2)}</td>
                                <td className="text-center">9%</td>
                                <td className="text-right">{(order.amounts?.tax / 2)?.toFixed(2)}</td>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td></td>
                                <td className="bold-label text-right">{(order.amounts?.tax / 2)?.toFixed(2)}</td>
                                <td></td>
                                <td className="bold-label text-right">{(order.amounts?.tax / 2)?.toFixed(2)}</td>
